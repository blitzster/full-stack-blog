    ...
    <div className='mt-4 flex flex-col gap-4'>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="">
          ...
          <p className='mt-8 text-md md:text-xl'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae provident ipsam minus, veritatis quidem animi dicta quas sequi</p>
        </div>
        {/* animated button */}
